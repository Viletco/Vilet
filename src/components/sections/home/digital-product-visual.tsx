...
export function DigitalProductVisual() {
  return (
    <figure
      className="vilet-ecosystem-window vilet-panel relative overflow-hidden border border-white/10"
    ...
    >
      <div className="flex items-center justify-between border-b border-white/[0.07] px-4 py-3">
        ...
        <span className="vilet-coordinate text-text-muted">Ecosystem / 01</span>
      </div>
        ...
        <div className="relative grid min-h-[18rem] content-between gap-8">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
            {products.map((item) => (
              <div
                key={item.product}
                className="vilet-mini-product vilet-product-tile p-3"
              >
                <ProductMark
